...
(function () {
    ...
    Global.List.Bind({
        Name: 'InventoryStockChangeHistory',
        Grid: {
            elm: $('#grid'),
            columns: [
                    { field: 'HMSInventoryItemName', title: 'Inventory Item Name', sorting: false, filter: true, Add: false },
                    { field: 'QuantityBefore', title: 'Quantity Before', filter: true },
                    { field: 'QuantityChanged', title: 'Quantity Changed', filter: true },
                    { field: 'QuantityAfter', title: 'QuantityAfter', filter: true },
            ...
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} Inventory Stock Change History ' },
