...
(function () {
    ...
    function onDetails(model) {
        Global.Add({
            model: model,
            name: 'InvestigationDetails',
            url: '/Content/IqraHMS/InvestigationArea/Js/InvestigationReportGroup/OnDetails.js',
        });
    };
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            url: '/InvestigationArea/InvestigationReportGroup/Get',
        ...
        Add: {
            onSubmit: onSubmit,
            save: '/InvestigationArea/InvestigationReportGroup/Create',
            saveChange: '/InvestigationArea/InvestigationReportGroup/Edit',
            //dropdownList: [
            //    {
            //        Id: 'InvestigationId',
            //        position: 1,
        ...
        remove: { save: '/InvestigationArea/InvestigationReportGroup/Delete' }
    });
})();;
