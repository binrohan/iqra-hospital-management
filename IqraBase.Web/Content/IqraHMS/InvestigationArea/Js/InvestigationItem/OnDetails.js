    ...
    function setGrid(container, model, name, creator) {
        ...
        model.Reload = function () {
            Global.Add({
                ...
                filter: filter,
                name: 'Item-Tab',
                url: '/Content/IqraHMS/InvestigationArea/Js/InvestigationItemRelation/ReportCategory.js',
                ...
                drp: [{
                    ...
                    position: 1,
                    url: function () {
                        return '/InvestigationArea/InvestigationReportCategory/AutoCompleteByItem?itemId=' + filter.value
                    },
                    Type: 'AutoComplete',
                }]
            });
