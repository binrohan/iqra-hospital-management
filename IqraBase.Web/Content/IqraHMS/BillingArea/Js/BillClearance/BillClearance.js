...
var Controller = new function () {
    ...
    function printDischargeBill(id) {
        Global.Add({
            PatientId: id,
            type: 'DischargePrint',
            name: 'printDischargeBill',
    ...
    this.Show = function (model) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraHMS/BillingArea/Templates/BillClearance.html', function (response) {
