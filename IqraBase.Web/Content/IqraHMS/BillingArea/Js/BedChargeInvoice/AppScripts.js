...
(function () {
    ...
    function onDetails(model) {
        Global.Add({
            BedChargeInvoiceId: model.Id,
            name: 'BedChargeInvoiceDetails',
            url: '/Areas/BillingArea/Content/BedChargeInvoice/BedChargeInvoiceDetails.js',
        });
    };
    ...
    Global.List.Bind({
        Name: 'BedChargeInvoice',
        Grid: {
            elm: $('#grid'),
            columns: [
                
                    { field: 'AdmissionCharge', title: 'Admission Charge' },
                    { field: 'BedCharge', title: 'Bed Charge' },
                    { field: 'BedChargeInvoiceDate', title: 'Bed Charge Invoice Date', dateFormat: 'dd mmm-yyyy', width: 180 },
            ...
            //}],
            url: '/BillingArea/BedChargeInvoice/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} BedChargeInvoices ' },
            ...
            onSubmit: onSubmit,
            save: '/BillingArea/BedChargeInvoice/Create',
            saveChange: '/BillingArea/BedChargeInvoice/Edit',
            //details: function (data) {
                //return '/BillingArea/BedChargeInvoice/Details?Id=' + data.Id;
            //},
            additionalField: [
        ...
        remove: { save: '/BillingArea/BedChargeInvoice/Delete' }
    });
