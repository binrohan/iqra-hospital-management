...
(function () {
    ...
    function onDetails(model) {
        Global.Add({
            ...
            url: '/Areas/CommonArea/Content/Department/DepartmentDetails.js',
        });
    };
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            //}],
            url: '/CommonArea/Department/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} Department ' },
            ...
            onSubmit: onSubmit,
            save: '/CommonArea/Department/Create',
            saveChange: '/CommonArea/Department/Edit',
        ...
        remove: { save: '/CommonArea/Department/Delete' }
    });
