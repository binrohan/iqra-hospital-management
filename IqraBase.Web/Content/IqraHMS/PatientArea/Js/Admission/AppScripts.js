...
(function () {
    ...
    Global.List.Bind({
        ...
        Grid: {
            elm: $('#grid'),
            columns: [
                 { field: 'Advance', title: 'Advance', filter: true },
                    { field: 'AdmissionCharge', title: 'Admission Charge', filter: true },
            ...
            onSubmit: onSubmit,
            save: '/PatientArea/Admission/Create',
            saveChange: '/PatientArea/Admission/Edit',
        ...
        remove: { save: '/PatientArea/Admission/Delete' }
    });
