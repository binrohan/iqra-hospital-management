...
(function () {
    function onSubmit(formModel, data) {
        if (data) {
            ...
            formModel.IsEditable = false
        }
    };
    function onDetails(model) {
        Global.Add({
            RoomCategoryId: model.Id,
            name: 'RoomCategoryDetails',
            url: '/Areas/RoomArea/Content/RoomCategory/RoomCategoryDetails.js',
        });
    };
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            columns: [
                    ...
                    { field: 'IsEditable', title: 'IsEditable', Add: false },
            ...
            //}],
            url: '/RoomArea/RoomCategory/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} RoomCategorys ' },
            ...
            onSubmit: onSubmit,
            save: '/RoomArea/RoomCategory/Create',
            saveChange: '/RoomArea/RoomCategory/Edit',
            //details: function (data) {
                //return '/RoomArea/RoomCategory/Details?Id=' + data.Id;
            //},
            additionalField: [
        ...
        remove: { save: '/RoomArea/RoomCategory/Delete' }
    });
