...
var Controller = new function () {
    ...
    function save() {
        if (formModel.IsValid) {
            ...
            model.Status = 'well';
            model.Id = none;
            Global.CallServer('/PatientArea/Patient/OnAppointCreate', function (response) {
                windowModel.Free();
                if (!response.IsError) {
                    callerOptions.onSaveSuccess(response);
                    service.Calendar.Reset();
    ...
    (function () {
        ...
        function setCalendar(cntr) {
            Global.Add({
                ...
                modules: [],
                url: '/Content/IqraHMS/AppointmentArea/Js/Calendar.js',
                Container: cntr || setContainer(),
                Success: function (time, availability, date,viewItem) {
