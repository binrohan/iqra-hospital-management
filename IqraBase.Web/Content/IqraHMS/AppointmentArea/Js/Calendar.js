...
var Controller = new function () {
    ...
    (function (none) {
        ...
        (function () {
            var availability;
            //function getSchedule(viewItem,availability) {
            //    console.log(['viewItem,availability', viewItem, availability]);
            //    var schedule = {};
            //    (viewItem.Schedule || []).each(function () {
            //        if(this.ScheduleStartAtTime)
            //    });
            //};
            function onSelectAppointment(availability, date, viewItem) {
                var tt = date.getTime() + availability.StartAtTime;
                var time = new Date(tt);
                //getSchedule(viewItem, availability);
                callerOptions.Success && callerOptions.Success(time, availability, date,viewItem);
            };
            function onClickViewPort(viewItem) {
                console.log(viewItem);
                if (viewItem.Availability.length == 1) {
                    onSelectAppointment(viewItem.Availability[0], viewItem.Date, viewItem);
                } else {
            ...
            function onClickSchedule(model) {
                console.log(model);
                onSelectAppointment(model.Availability, model.ViewItem.Date, viewItem);
            };
