...
(function () {
    ...
    function onDetails(model) {
        Global.Add({
            DrugCompanyId: model.Id,
            name: 'DrugCompanyDetails',
            url: '/Areas/DrugArea/Content/DrugCompany/DrugCompanyDetails.js',
        });
    };
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            columns: [
                    ...
                    { field: 'CompanyPriority', title: 'CompanyPriority', filter: true },
            ...
            //}],
            url: '/DrugArea/DrugCompany/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} DrugCompanys ' },
            ...
            onSubmit: onSubmit,
            save: '/DrugArea/DrugCompany/Create',
            saveChange: '/DrugArea/DrugCompany/Edit',
            //details: function (data) {
                //return '/DrugArea/DrugCompany/Details?Id=' + data.Id;
            //},
            additionalField: [
        ...
        remove: { save: '/DrugArea/DrugCompany/Delete' }
    });
