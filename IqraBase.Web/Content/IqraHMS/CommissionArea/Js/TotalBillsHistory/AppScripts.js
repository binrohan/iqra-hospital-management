...
(function () {
    ...
    function onDetails(model) {
        Global.Add({
            TotalBillsHistoryId: model.Id,
            name: 'TotalBillsHistoryDetails',
            url: '/Areas/CommissionArea/Content/TotalBillsHistory/TotalBillsHistoryDetails.js',
        });
    };
    ...
    Global.List.Bind({
        Name: 'TotalBillsHistory',
        Grid: {
            elm: $('#grid'),
            columns: [
                
                    { field: 'PaidAmount', title: 'Paid Amount' },
                    { field: 'PaymentDate', title: 'Payment Date', dateFormat: 'dd mmm-yyyy' },
            ...
            //}],
            url: '/CommissionArea/TotalBillsHistory/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} TotalBillsHistories ' },
            ...
            onSubmit: onSubmit,
            save: '/CommissionArea/TotalBillsHistory/Create',
            saveChange: '/CommissionArea/TotalBillsHistory/Edit',
            //details: function (data) {
                //return '/CommissionArea/TotalBillsHistory/Details?Id=' + data.Id;
            //},
            additionalField: [
        ...
        remove: { save: '/CommissionArea/TotalBillsHistory/Delete' }
    });
