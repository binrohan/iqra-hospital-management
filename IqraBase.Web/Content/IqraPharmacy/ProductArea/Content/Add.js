...
var Controller = new function (none) {
    ...
    function save() {
        if (formModel.IsValid) {
            var model = getModel();
            //console.log([options.Type === 1 && (options.model.SalesUnitTypeId != model.SalesUnitTypeId), options.Type === 1, (options.model.SalesUnitTypeId != model.SalesUnitTypeId), options.Type, options.model.SalesUnitTypeId , model.SalesUnitTypeId]);
            ...
            var model = {
                ...
                change: function (data) {
                    if (data) {
                        ...
                        console.log(['/SuplierArea/Suplier/AutoCompleteWithCounter', formModel]);
                    }
                }
            };
