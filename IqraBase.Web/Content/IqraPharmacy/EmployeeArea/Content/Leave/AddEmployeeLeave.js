var Controller=AddEmployeeLeave = new function () {
    ...
    function save() {
        if (formModel.IsValid) {
            windowModel.Wait();
            var model = getModel();
            Global.CallServer('/EmployeeArea/Leave/AddNew', function (response) {
                if (!response.IsError) {
                    windowModel.Free();
    ...
    this.Show = function (opts) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/EmployeeArea/Templates/AddEmployeeLeave.html', function (response) {
    ...
    this.Events = new function () {
        ...
        function bindDropDown() {
            drp = { elm: $(formInputs['CategoryId']), Id: 'CategoryId', url: '/EmployeeArea/LeaveCategory/DropDown', change: onDropDownChange };
