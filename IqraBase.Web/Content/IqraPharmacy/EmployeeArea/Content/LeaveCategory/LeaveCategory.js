...
(function () {
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            url: '/EmployeeArea/LeaveCategory/Get',
            ...
            onSubmit: onSubmit,
            save: '/EmployeeArea/LeaveCategory/Create',
            saveChange: '/EmployeeArea/LeaveCategory/Edit'
        },
        remove: { save: '/EmployeeArea/LeaveCategory/Delete' }
    });
