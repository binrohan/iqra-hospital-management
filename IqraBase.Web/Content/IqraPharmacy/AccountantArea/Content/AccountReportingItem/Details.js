...
var Controller = new function () {
    ...
    this.Show = function (model) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/AccountantArea/Templates/AccountReportingItem/Details.html', function (response) {
    ...
    (function () {
        ...
        function onDetails(model) {
            Global.Add({
                ...
                url: '/Content/IqraPharmacy/AccountantArea/Content/AccountReportingItem/ItemDetails.js',
            });
        };
        ...
        function getOptions() {
            var opts = {
                ...
                ,
                remove:
                    { save: '/AccountantArea/AccountReportingItem/Delete' }
            };
            return opts;
        };
        this.Bind = function () {
