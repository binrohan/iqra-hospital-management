...
(function () {
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            url: '/AccountantArea/AccountReporting/Get',
        ...
        Add: {
            onSubmit: onSubmit,
            save: '/AccountantArea/AccountReporting/Create',
            saveChange: '/AccountantArea/AccountReporting/Edit'
        },
        remove: { save: '/AccountantArea/AccountReporting/Delete' }
    });
})();
