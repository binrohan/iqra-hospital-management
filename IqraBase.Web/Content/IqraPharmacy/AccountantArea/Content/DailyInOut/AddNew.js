var Controller = new function () {
    ...
    function createWindow(template) {
        ...
        Global.DatePicker.Bind($(formInputs['Date']), { format: 'dd/MM/yyyy', onChange: service.Loader.Load });
        show();
    };
    ...
    (function () {
        var headers = [
            ...
            'Manual Journal', 'Bank Transfer', 'Purchase Cancel', 'Suplier Return', 'PurchaseByItem',
            'PurchaseByReturn', 'FiexdAsset', 'FiexdAsset Depreciation', 'FiexdAsset Depreciation Expense',
            'Bill', 'Bill Payment', 'Employee Salary Payment', 'Inventory Due Payment', '', '', '', '', '', '', '', '', '', '', '', '', '', ''
        ];
        /// 20 For Bill
        /// 21 For Bill Payment
        /// 22 Employee Salary Payment
        /// 23 InventoryDuePayment
