var Controller = new function () {
    ...
    this.Show = function (opts) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/ExpenseArea/Templates/AddFiles.html', function (response) {
    ...
    (function () {
        ...
        function save(model) {
            model.request = Global.Uploader.upload({
                data: model.Data,
                url: '/ExpenseArea/Expense/AddFiles',
        ...
        function createView(src, file) {
            ...
            var model = {
                ...
                Data: {
                    ...
                    ExpenseItemId: options.model.Id
                }
            };
