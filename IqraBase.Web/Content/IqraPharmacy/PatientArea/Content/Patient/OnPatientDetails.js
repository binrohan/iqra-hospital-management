var Controller = new function () {
    ...
    function onCreate(func) {
        Global.Add({
            PatientId: callarOptions.PatientId,
    ...
    function setGrid(container, model) {
        ...
        model.Reload = function () {
            Global.Add({
                ...
                BaseModel: model,
                filter: [filter],
                name: 'InventoryDuePayment',
                url: '/Content/IqraPharmacy/InventoryArea/Content/InventoryDuePayment/AppScript.js',
        ...
        Global.Click(view.find('.button_container a'), onCreate, function () {
            ...
            Tabs: [
                {
                    ...
                    Columns: [
                            ...
                            { field: 'Email' },
                            { field: 'Age' },
                            { field: 'BedNumber', title: 'Bed' },
                            { field: 'BedName', title: 'Bed-Type' },
                            { field: 'Balance', type: 2 },
                    ...
                    DetailsUrl: function () {
                        return '/PatientArea/PharmacyPatient/Details?Id=' + callarOptions.PatientId;
                    }
                },
                getTab('Purchase History', service.Purchase.Bind),
                //getTab('Payment History', setGrid),
                getTab('Product Return', service.Return.Bind)
            ],
    ...
    (function () {
        ...
        this.Bind = function (container, model) {
            ...
            view.find('#btn_add_new').remove();
        };
    }).call(service.Purchase = {});
    (function () {
        var tabModel = {}, view = getView(), gridModel;
        function setView(container) {
            view.find('#btn_add_new').after(`
                <a href="#" class="btn btn-white btn-success btn-round pull-right" id="btn_add_by_voucher" style="margin-left: 1%"><span class="glyphicon glyphicon-plus"></span>Add By Voucher</a>
                <a href="#" class ="btn btn-white btn-success btn-round pull-right" id="btn_add_by_item" style="margin-left: 1%"><span class ="glyphicon glyphicon-plus"></span>Add By Item</a>`).remove();

            container.append(view);
        };
        function addByVoucher() {
            Global.Add({
                model: model,
        ...
        function addByItem() {
            Global.Add({
                ...
                url: '/Content/IqraPharmacy/PatientArea/Content/Patient/ProductReturn/AddReturnByItem.js',
            });
        };
        function setEvent() {
            Global.Click(view.find('#btn_add_by_voucher'), addByVoucher);
            Global.Click(view.find('#btn_add_by_item'), addByItem);
        };
        function getFilter() {
            return Global.Filters().Bind({
                container: view.find('#filter_container'),
