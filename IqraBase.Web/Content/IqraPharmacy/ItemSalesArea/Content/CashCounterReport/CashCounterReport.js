...
page = { 'PageNumber': 1, filter: [from, to], 'PageSize': 50, showingInfo: ' {0}-{1} of {2} Employees ' };
    ...
    function onDetails(model) {
        Global.Add({
            ...
            name: 'CashCounterReportDetails',
            url: '/Content/IqraPharmacy/ItemSalesArea/Content/CashCounterReport/CashCounterReportDetails.js',
        });
    };
    function setSummary(model) {
        model.Items = model.Items || 0;
        model.Discount = model.Discount || 0;
        model.ReturnAmount = model.ReturnAmount || 0;
    ...
    function onDataBinding(data) {
        ...
        data.Data.Data.each(function () {
            this.ReturnAmount = this.ReturnAmount || 0;
    ...
    (function () {
        Global.Grid.Bind({
            elm: $('#grid'),
            columns: [
                        { field: 'Computer', title: 'Employee', click: onDetails },
            ...
            url: '/ItemSalesArea/ItemSales/GetCashCounterReport',
            page: page,
