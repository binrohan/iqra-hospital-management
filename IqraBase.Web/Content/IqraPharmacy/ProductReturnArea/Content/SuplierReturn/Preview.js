...
var Controller = new function () {
    ...
    function save() {
        ...
        Global.Uploader.upload({
            ...
            url: '/ProductReturnArea/SuplierReturn/AddNew',
    ...
    this.Show = function (model) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate(callerOptions.template || '/Content/IqraPharmacy/ProductReturnArea/Templates/SuplierReturnPreview.html', function (response) {
