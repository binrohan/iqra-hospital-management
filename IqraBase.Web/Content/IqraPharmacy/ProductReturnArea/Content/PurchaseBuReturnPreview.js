...
var Controller = new function () {
    ...
    this.Show = function (model) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/ProductReturnArea/Templates/PurchaseByReturnPreview.html', function (response) {
        ...
        function getOptions() {
            var opts = {
                ...
                columns: [
                    ...
                    { field: 'ReturnPricePrv', title: 'Returned Amount' }
