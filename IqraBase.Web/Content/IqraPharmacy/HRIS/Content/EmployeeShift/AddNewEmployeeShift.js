var Controller = new function () {
    ...
    function save() {
        if (formModel.IsValid) {
            windowModel.Wait();
            var model = getModel();
            Global.CallServer('/HRIS/EmployeeShift/AddNew', function (response) {
                if (!response.IsError) {
                    windowModel.Free();
    ...
    this.Show = function (opts) {
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/HRIS/Templates/EmployeeShift/AddNewEmployeeShift.html', function (response) {
