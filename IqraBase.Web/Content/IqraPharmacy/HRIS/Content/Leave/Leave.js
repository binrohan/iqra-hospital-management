...
(function () {
    var opts = {
        ...
        url: '/Content/IqraPharmacy/HRIS/Content/Leave/AddEmployeeLeave.js',
    ...
    function onDetails(model) {
        Global.Add({
            ...
            url: '/Content/IqraPharmacy/HRIS/Content/Leave/LeaveDetails.js',
        });
    };
    function onAdd() {
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            url: '/HRIS/Leave/Get',
            page: { 'PageNumber': 1, 'PageSize': 10, showingInfo: ' {0}-{1} of {2} Leaves ', filter: [{ field: 'EmployeeId', operation: 0, value: appUser.Id }] },
