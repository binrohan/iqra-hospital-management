...
(function () {
    ...
    function onSetStatus(model, msg) {
        var opts = {
            ...
            Msg: msg,
            save: '/PayrollArea/OverTimeSetting/onApprove'
        };
    ...
    function getAdd() {
        ...
        if (accessModel.Edit || accessModel.Create) {
            return {
                onSubmit: onSubmit,
                save: '/PayrollArea/OverTimeSetting/Create',
                saveChange: '/PayrollArea/OverTimeSetting/Edit',
                dropdownList: [
                             {
                                 Id: 'EmployeeId',
                                 position: 1,
                ...
                details: function (data) {
                    console.log(data);
                    return '/PayrollArea/OverTimeSetting/Details?Id=' + data.Id
                }
            };
        } else {
            return false;
    ...
    Global.List.Bind({
        ...
        Grid: {
            ...
            url: '/PayrollArea/OverTimeSetting/Get',
