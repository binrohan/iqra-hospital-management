...
var Controller = new function () {
    var filter = { "field": "LoanTypeId", "value": "", Operation: 0 };
    ...
    this.Show = function (model) {
        ...
        Global.Add({
            model: model.model,
            //DetailsUrl: '/PayrollArea/LoanAccount/Get',
            Grid: [{
            ...
            name: 'OnLoanTypeDetails',
            url: '/Content/IqraService/Js/OnDetailsWithGrid.js?Type=LoanTypeDetails'
        });
    };
};