...
var Controller = new function () {
    var service = {}, windowModel, dataSource = {}, selected = {}, callerOptions,
        filter = { "field": "DayInfoId", "value": "", Operation: 0 },
    ...
    this.Show = function (model) {
        selected = {};
        callerOptions = model;
        filter.value = model.DailyInfoId;
        ...
        if (windowModel) {
            ...
            Global.LoadTemplate('/Content/IqraPharmacy/DailyInfoItemArea/Templates/DailyInfoDetails.html', function (response) {
