...
var Controller = new function () {
    var service = {}, windowModel, dataSource = {}, formModel = {}, inputs, gridModel, callerOptions,date=new Date(),
        from = { field: 'SaleFrom', value: "'" + date.format('yyyy/MM/dd') + ' 00:00' + "'", Operation: 2 },
        to = { field: 'SaleTo', value: "'" + new Date(date.setDate(date.getDate()+1)).format('yyyy/MM/dd') + ' 00:00' + "'", Operation: 3 },
    ...
    function onChange() {
        ...
        if (formModel.SaleTo) {
            filter.push({ field: 'SaleTo', value: "'" + formModel.SaleTo + "'", Operation: 3 });
        }
        if (gridModel) {
